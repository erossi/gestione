...
<? if (file_exists('../../procedure/function_crea_articolo.php'))
 { include '../../procedure/function_crea_articolo.php'; } ?>
...
<? print_title('Crea articolo'); ?>

<?php
print '<br>';

$link='nuovo_articolo_commit.php';
