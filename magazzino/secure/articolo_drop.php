...
<?php
    ...
    if (!$result) {
        print 'file articolo_drop error: cannot execute query.\n';
        exit;
    };
...
print'Please modifica i dati e premi <b>Scarica</b><br>';
print'<form method="post" action="articolo_drop_commit.php?codice_art=' . $codice_art . '">';
...
print'<table cellspacing="1" cellpadding="3" border="0">';
    ...
    print '<td align="right" valign="middle" bgcolor="#336699"><font face="arial,helvetica,sans-serif" size="2">Disponibili&agrave</font></td>';
    print '<td align="left"  valign="middle">' . $arr['quantita'] . '</td>';
    print '</tr>';
    ...
    print '    <tr>';
    print '        <td align="right" valign="middle" bgcolor="#336699"><font face="arial,helvetica,sans-serif" size="2">Quantit&agrave</font></td>';
    print '        <td align="left"  valign="middle"><input type="text" name="quantita_scarico" size="5" align="absmiddle"></td>';
    ...
    print '    <tr>';
    print '        <td align="right" valign="middle" bgcolor="#336699"><font face="arial,helvetica,sans-serif" size="2">Data di vendita</font></td>';
    print '        <td align="left"  valign="middle"><input type="text" name="data_vendita" size="20" align="absmiddle"></td>';
    print '    </tr>';

    print '    <tr>';
    print '        <td>&nbsp</td>';
    print '        <td><input type="submit" name="submit" value="Scarica">&nbsp;<input type="reset" name="reset" value="Annulla"></td>';
    print '    </tr>';
