...
<? if (file_exists('../../procedure/function_carica_articolo_full.php'))
 { include '../../procedure/function_carica_articolo_full.php'; } ?>
...
$link='carica_articolo_commit.php?codice_cat=' . $arr['codice_cat']
