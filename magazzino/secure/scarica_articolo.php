...
<? if (file_exists('../../procedure/function_scarica_articolo_full.php'))
 { include '../../procedure/function_scarica_articolo_full.php'; } ?>
...
$link='scarica_articolo_commit.php?codice_cat=' . $arr['codice_cat']
...
scarica_articolo_full ($arr,$link);
