...
<? print_title('Esegui caricamento nuovo articolo'); ?>
...
$errori=0;
$quantita_carico=$quantita;
if ($codice_art == '' || $quantita_carico == '' || $codice_cat == '')
     {
...
$query="INSERT INTO movimenti
 (codice_cat, codice_art, descrizione, tipo_movimento,
  quantita, prezzo, data_movimento)
 VALUES
 ('" . $codice_cat . "',
 '" . $codice_art . "',
 '" . $note . "',
