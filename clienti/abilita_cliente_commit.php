...
// mail al cliente di conferma abilitazione
// i parametri sono in default.php
$from="From: $d_conferma_from";
$msg="$d_conferma_msg \n\n" .
  "Codice utente (username): $codice \n" .
  "Password: $password \n\n";

 mail($resp_mail, $d_conferma_subj, $msg, $from);

 print "<br><br> Abilitazione e conferma email terminata.<br>";
?>
