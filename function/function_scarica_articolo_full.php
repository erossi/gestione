...
print'<form method="post" action="' . $action . '">';
 ...
 print '<td align="left"  valign="middle">' . $arr['prezzo_acq'] . '</td>';
 print '</tr>';

 print '<tr>';
 print '<td align="right" valign="middle" bgcolor="#336699">Prezzo di Vendita 1</td>';
 print '<td align="left"  valign="middle">' . $arr['prezzo_ven1'] . '</td>';
 print '<td align="right" valign="middle" bgcolor="#336699">Prezzo di Vendita 2</td>';
 print '<td align="left"  valign="middle">' . $arr['prezzo_ven2'] . '</td>';
 print '</tr>';

 print '<tr>';
 print '<td align="right" valign="middle" bgcolor="#336699">Prezzo di Vendita 3</td>';
 print '<td align="left"  valign="middle">' . $arr['prezzo_ven3'] . '</td>';
 print '<td align="right" valign="middle" bgcolor="#336699">Prezzo di Vendita 4</td>';
 print '<td align="left"  valign="middle">' . $arr['prezzo_ven4'] . '</td>';
 print '</tr>';

 print '<tr>';
 print '<td align="right" valign="middle" bgcolor="#336699">Prezzo di vendita</td>';
 print '<td align="left"  valign="middle"><input type="text" name="prezzo_ven" size="15" align="absmiddle" value="' . $arr['prezzo_ven1'] . '"></td>';
 ...
 print '<tr>';
 print '<td align="right" valign="middle" bgcolor="#336699">Data di vendita</td>';
 print '<td align="left"  valign="middle"><input type="text" name="data" size="20" align="absmiddle" value=""></td>';
 print '</tr>';
